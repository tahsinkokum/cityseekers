...
<head>
    ...
    <title>trabzon - CitySeekers</title>
    <link rel="stylesheet" href="trabzon.css" />
    <style>
        #rating span {
            font-size: 24px;
            cursor: pointer;
...
<body>
    ...
    <div class="hero">
        <video autoplay muted loop>
            <source src="../videos/trabzon.mp4" type="video/mp4">
        </video>
        <div class="hero-overlay">
            <h1>Trabzon</h1>
            <p>Karadeniz’in gözde şehri Trabzon, yeşil doğası ve tarihi yapılarıyla büyüler. Sümela Manastırı, Uzungöl ve yaylaları ile meşhurdur.</p>
        </div>
    </div>
