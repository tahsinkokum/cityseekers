...
<head>
    ...
    <title>Ankara - CitySeekers</title>
    <link rel="stylesheet" href="ankara.css" />
    <style>
        #rating span {
            font-size: 24px;
            cursor: pointer;
...
<body>
    ...
    <div class="hero">
        <video autoplay muted loop>
            <source src="../videos/ankara.mp4" type="video/mp4">
        </video>
        <div class="hero-overlay">
            <h1>Ankara</h1>
            <p>Ankara, Türkiye'nin başkentidir. Anıtkabir, Ankara Kalesi ve Anadolu Medeniyetleri Müzesi gibi tarihi yapılarıyla dikkat çeker.</p>
        </div>
    </div>
