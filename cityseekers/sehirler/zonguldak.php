...
<head>
    ...
    <title>zonguldak - CitySeekers</title>
    <link rel="stylesheet" href="zonguldak.css" />
    <style>
        #rating span {
            font-size: 24px;
            cursor: pointer;
...
<body>
    ...
    <div class="hero">
        <video autoplay muted loop>
            <source src="../videos/zonguldak.mp4" type="video/mp4">
        </video>
        <div class="hero-overlay">
            <h1>Zonguldak</h1>
            <p>Karadeniz kıyısındaki Zonguldak, kömür madenleriyle tanınır. Filyos Antik Kenti ve Gökgöl Mağarası gibi doğa ve tarih iç içedir.</p>
        </div>
    </div>
