...
<head>
    ...
    <title>tokat - CitySeekers</title>
    <link rel="stylesheet" href="tokat.css" />
    <style>
        #rating span {
            font-size: 24px;
            cursor: pointer;
...
<body>
    ...
    <div class="hero">
        <video autoplay muted loop>
            <source src="../videos/tokat.mp4" type="video/mp4">
        </video>
        <div class="hero-overlay">
            <h1>Tokat</h1>
            <p>Tokat, yeşilin her tonunu barındıran vadileri, tarihi hanları ve bereketli topraklarıyla Anadolu’nun saklı hazinelerindendir. El sanatlarıyla süslenmiş sokaklarında tarih fısıldar, her köşesi kültürle yoğrulmuştur..</p>
        </div>
    </div>
