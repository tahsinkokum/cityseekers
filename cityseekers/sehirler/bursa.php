...
<head>
    ...
    <title>bursa - CitySeekers</title>
    <link rel="stylesheet" href="bursa.css" />
    <style>
        #rating span {
            font-size: 24px;
            cursor: pointer;
...
<body>
    ...
    <div class="hero">
        <video autoplay muted loop>
            <source src="../videos/bursa.mp4" type="video/mp4">
        </video>
        <div class="hero-overlay">
            <h1>Bursa</h1>
            <p>Osmanlı'ya başkentlik yapmış olan Bursa, tarihi çarşıları, camileri ve Uludağ ile ünlüdür. Aynı zamanda kestanesi, İskender kebabı ve termal kaplıcalarıyla da meşhurdur. Hem doğa hem tarih severler için harika bir destinasyondur.</p>
        </div>
    </div>
