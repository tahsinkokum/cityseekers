...
<head>
    ...
    <title>eskisehir - CitySeekers</title>
    <link rel="stylesheet" href="eskisehir.css" />
    <style>
        #rating span {
            font-size: 24px;
            cursor: pointer;
...
<body>
    ...
    <div class="hero">
        <video autoplay muted loop>
            <source src="../videos/eskisehir.mp4" type="video/mp4">
        </video>
        <div class="hero-overlay">
            <h1>Eskisehir</h1>
            <p>Eskişehir, öğrenci dostu şehir atmosferiyle ve Porsuk Çayı ile tanınır.Modern yapıları, Odunpazarı evleri ve kültürel etkinlikleri ile dikkat çeker.</p>
        </div>
    </div>
