...
<head>
    ...
    <title>gaziantep - CitySeekers</title>
    <link rel="stylesheet" href="gaziantep.css" />
    <style>
        #rating span {
            font-size: 24px;
            cursor: pointer;
...
<body>
    ...
    <div class="hero">
        <video autoplay muted loop>
            <source src="../videos/gaziantep.mp4" type="video/mp4">
        </video>
        <div class="hero-overlay">
            <h1>Gaziantep</h1>
            <p>Türkiye'nin gastronomi başkenti Gaziantep, baklavası, kebapları ve tarihi hanları ile ünlüdür.Zeugma Mozaik Müzesi, en çok ziyaret edilen yerlerden biridir.</p>
        </div>
    </div>
