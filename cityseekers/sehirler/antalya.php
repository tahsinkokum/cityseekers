...
<head>
    ...
    <title>antalya - CitySeekers</title>
    <link rel="stylesheet" href="antalya.css" />
    <style>
        #rating span {
            font-size: 24px;
            cursor: pointer;
...
<body>
    ...
    <div class="hero">
        <video autoplay muted loop>
            <source src="../videos/antalya.mp4" type="video/mp4">
        </video>
        <div class="hero-overlay">
            <h1>Antalya</h1>
            <p>Antalya, tarihi kalıntıları, berrak denizi ve doğal güzellikleriyle Türkiye’nin en önemli turizm merkezlerinden biridir.</p>
        </div>
    </div>
